...
Scenario: sort movies alphabetically
  # your scenario here
  When I have chosen to see movies sorted by title alphabetically
...
Scenario: sort movies in increasing order of release date
  # your scenario here
  When I have chosen to see movies sorted by release date in increasing order
...
# shorter scenarios
Scenario: sort movies alphabetically 2
  # your scenario here
  When I have chosen to see movies sorted by title alphabetically
...
Scenario: sort movies in increasing order of release date
  # your scenario here
  When I have chosen to see movies sorted by release date in increasing order
  Then I should see movies ordered by release date in increasing order
